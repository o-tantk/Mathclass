#pragma once
...
#ifdef TFM_DOUBLE_BASED
    typedef double real_t;
    #define PI 3.141592653589793238463
    #define EPSILON 1e-10
    #define PI_PER_HALF 0.017453292519943295474
    #define HALF_PER_PI 57.295779513082322864648
    ...
    #define PI_PER_HALF 0.01745329251994f
    #define HALF_PER_PI 57.29577951308232f
